...
public class Gui extends JFrame {
	...
	private JMenuItem MenuItemSchlieﬂen;
	...
	public Gui() {
		...
		MenuItemSchlieﬂen = new JMenuItem("Schlie\u00DFen");
		MenuItemSchlieﬂen.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				do_MenuItemSchlieﬂen_mouseClicked(e);
			}
		});
		mnNewMenu.add(MenuItemSchlieﬂen);
	...
	protected void do_MenuItemSchlieﬂen_mouseClicked(MouseEvent e) {
